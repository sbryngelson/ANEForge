...
Accumulated across **8 machine(s)**, 11 submission(s). Each row is a distinct machine (grouped by hardware hash; identical silicon in different chassis stays separate by model identifier).
...
Thanks to [@Rayan-and-beyond](https://github.com/Rayan-and-beyond), [@axiom-of-choice](https://github.com/axiom-of-choice), [@danlee2002](https://github.com/danlee2002), [@diegobauavi](https://github.com/diegobauavi), [@n0madic](https://github.com/n0madic), [@sbryngelson](https://github.com/sbryngelson) for contributing datapoints.
...
| Apple M4 Max | Mac16,6 | 10+4 | 32 | 36 GB unified | 26.7 (25G229) | ac | 654b1d772321 (dirty) | [@n0madic](https://github.com/n0madic) | 1 |
| Apple M5 | Mac17,3 | 4+6 | 8 | 16 GB unified | 26.5.2 (25F84) | ac | 5054f070d1cb (dirty) | [@danlee2002](https://github.com/danlee2002) | 2 |
...
| --- | --- | --- | --- | --- |
| Apple M1 | MacBookAir10,1 | ~32759 | clamp @ 4094 | <= 2048 |
...
| Apple M4 Max | Mac16,6 | ~32759 | exact (no clamp) | <= 2048 |
| Apple M5 | Mac17,3 | ~32759 | exact (no clamp) | <= 2048 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Apple M1 | MacBookAir10,1 | 4.3 | 5.4 | 802 | 622 | 278 | ac |
...
| Apple M4 Max | Mac16,6 | 8.9 | 23 | 385 | 1103 | - | ac |
