...
Auto-generated from the ANEForge reverse-engineering (the 187-op × device matrix +
...
OP_CATALOG: dict[str, dict] = {
    ...
    'prelu': {'category': 'Activations (incl. LUT)', 'm1': 'native', 'm2': 'native', 'm3': 'native', 'm4_m5': 'native', 'kernel': 'PRelu', 'mil_status': 'lut_activation_or_special_function', 'note': 'per-channel α (LUT); native at rank ≥3 (M1-confirmed)'},
    ...
    'conv': {'category': 'Conv / MatMul / Pooling', 'm1': 'native', 'm2': 'native', 'm3': 'native', 'm4_m5': 'native', 'kernel': 'Conv', 'mil_status': 'neconv_or_ne_lane', 'note': 'F0; M1 kernels ≤29×29 (13×13 fp16), 3D depth native A13+; M5 ≤32×32'},
    ...
    'resample': {'category': 'Image / resize / texture', 'm1': 'walled', 'm2': 'native', 'm3': 'native', 'm4_m5': 'native', 'kernel': 'Resample', 'mil_status': 'template_text_or_unresolved_backend', 'note': '**texture-engine only (A14+)**; warp depth=1, channel∈{1,2}. Walled on M1'},
    ...
    'resize_nearest_neighbor': {'category': 'Image / resize / texture', 'm1': 'bridge', 'm2': 'native', 'm3': 'native', 'm4_m5': 'native', 'kernel': 'ResizeNearestNeighbor', 'mil_status': 'neconv_or_ne_lane', 'note': 'NE lane; sw-fallback on M1 (1×1-source fast path exists)'},
    ...
    'local_response_norm': {'category': 'Normalization', 'm1': 'native', 'm2': 'native', 'm3': 'native', 'm4_m5': 'native', 'kernel': 'LRNorm', 'mil_status': 'lut_activation_or_special_function', 'note': 'LRN bridge (measured ✓ on M1)'},
    # --- Quantization / dtype ---
    ...
    # --- Reductions ---
    'reduce_argmax': {'category': 'Reductions', 'm1': 'native', 'm2': 'native', 'm3': 'native', 'm4_m5': 'native', 'kernel': 'ReduceArg', 'mil_status': 'template_text_or_unresolved_backend', 'note': 'per-axis ArgMax — F0, all chips (bridge `ArgMax` measured ✓ on M1)'},
    ...
    'cost_volume': {'category': 'Special / math', 'm1': 'bridge', 'm2': 'bridge', 'm3': 'bridge', 'm4_m5': 'bridge', 'kernel': 'CostVolume', 'mil_status': 'mapped_no_current_hwx_case', 'note': 'bridge `CostVolume` (measured ✓ on M1); `mapped_no_current_hwx_case`'},
    'cross_product': {'category': 'Special / math', 'm1': 'bridge', 'm2': 'bridge', 'm3': 'bridge', 'm4_m5': 'bridge', 'kernel': 'CrossProduct', 'mil_status': 'mapped_no_current_hwx_case', 'note': 'bridge `CrossProduct` (measured ✓ on M1) but `mapped_no_current_hwx_case` in MIL map — reachable via bridge'},
    ...
    'pad': {'category': 'Structural / shape', 'm1': 'native', 'm2': 'native', 'm3': 'native', 'm4_m5': 'native', 'kernel': 'Pad', 'mil_status': 'neconv_or_ne_lane', 'note': 'const pad F0 (NE lane). **symmetric/reflect pad is texture-gated → ⚠/sw on M1**, native A14+'},
    ...
    'space_to_batch': {'category': 'Structural / shape', 'm1': 'native', 'm2': 'native', 'm3': 'native', 'm4_m5': 'native', 'kernel': 'SpaceToBatch', 'mil_status': 'template_text_or_unresolved_backend', 'note': 'factor ∈{2,3,4,8}; batch cap 4096 (older)/65536'},
